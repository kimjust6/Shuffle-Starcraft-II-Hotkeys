...
def main():
    ...
    for x in accounts:
        makeShuffle()
        shutil.move( "C:\\Users\\MLT-Lenovo\\Downloads\\MLT-Shuffle.SC2Hotkeys", "Z:\\My Drive\\Dropbox\\New folder (3)\\Starcraft II\\Accounts\\" + x + "\Hotkeys\MLT.SC2Hotkeys")
...
#            print("7: ", number, line)
    ...
    outputfile = open("C:\\Users\\MLT-Lenovo\\Downloads\\MLT-Shuffle.SC2Hotkeys", "w")
